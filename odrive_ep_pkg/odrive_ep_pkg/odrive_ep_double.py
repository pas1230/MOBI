...
class Odrive_ep(Node):
    ...
    def __init__(self):
        super().__init__('odrive_ep_double')
        

        self.goal_pos = [0.0, 0.0, 0.0, 0.0]
        self.goal_vel = [0.0, 0.0, 0.0, 0.0]
        self.cur_pos = [0.0, 0.0, 0.0, 0.0]
        self.cur_vel = [0.0, 0.0, 0.0, 0.0]

        self.odrv1 = odrive.find_any(serial_number=odrive_serial_id1)
        self.odrv2 = odrive.find_any(serial_number=odrive_serial_id2)
        self.get_logger().info(f"odrv1 connected.  voltage : {self.odrv1.vbus_voltage}")
        self.get_logger().info(f"odrv2 connected.  voltage : {self.odrv2.vbus_voltage}")
        self.init_odrive()
        ...
        self.publisher_ = self.create_publisher(Motor, 'current_posvel_double', 10, callback_group=self.group1)
        timer_period = 0.5
    ...
    def timer_callback(self):
        ...
        self.odrv2.axis0.watchdog_feed()
        self.odrv2.axis1.watchdog_feed()
    ...
    def SetMode_callback(self, request, response):
        ...
        if mode == "pos":
            ...
            self.odrv2.axis0.clear_errors()
            self.odrv2.axis1.clear_errors()
            ...
            self.odrv2.axis0.requested_state = 8         # CLOSED_LOOP_CONTROL
            self.odrv2.axis1.requested_state = 8         # CLOSED_LOOP_CONTROL
            time.sleep(0.2)
    ...
    def init_odrive(self):
        ...
        self.odrv2.axis0.config.enable_watchdog = False
        self.odrv2.axis1.config.enable_watchdog = False
        time.sleep(0.1)
        self.odrv1.axis0.clear_errors()
        self.odrv1.axis1.clear_errors()
        self.odrv2.axis0.clear_errors()
        ...
        self.odrv2.axis0.requested_state = 3 # AXIS_STATE_FULL_CALIBRATION
        self.odrv2.axis1.requested_state = 3 # AXIS_STATE_FULL_CALIBRATION
        time.sleep(calibration_time)
        if self.odrv1.axis0.motor.is_calibrated == 1 and self.odrv1.axis1.motor.is_calibrated == 1 and self.odrv2.axis0.motor.is_calibrated == 1 and self.odrv2.axis1.motor.is_calibrated == 1:
        ...
        if self.odrv1.axis0.encoder.is_ready == 1 and self.odrv1.axis1.encoder.is_ready == 1 and self.odrv2.axis0.encoder.is_ready == 1 and self.odrv2.axis1.encoder.is_ready == 1:
        ...
        self.odrv1.axis0.config.watchdog_timeout = 1
        self.odrv1.axis1.config.watchdog_timeout = 1
        self.odrv2.axis0.config.watchdog_timeout = 1
        self.odrv2.axis1.config.watchdog_timeout = 1
        self.odrv1.axis0.watchdog_feed()
        self.odrv1.axis1.watchdog_feed()
        self.odrv2.axis0.watchdog_feed()
        self.odrv2.axis1.watchdog_feed()
        ...
        self.odrv2.axis0.config.enable_watchdog = True
        self.odrv2.axis1.config.enable_watchdog = True
        ...
        self.odrv2.axis0.trap_traj.config.vel_limit = 10
        self.odrv2.axis0.trap_traj.config.accel_limit = 2
        self.odrv2.axis0.trap_traj.config.decel_limit = 2
    ...
    def set_traj_control(self):
        ...
        self.odrv2.axis0.controller.config.input_mode = 1         #PASSTHROUGH
        self.odrv2.axis1.controller.config.input_mode = 1         #PASSTHROUGH

        self.odrv1.axis0.controller.input_pos = self.odrv1.axis0.encoder.pos_estimate
        self.odrv1.axis1.controller.input_pos = self.odrv1.axis1.encoder.pos_estimate
        self.odrv2.axis0.controller.input_pos = self.odrv1.axis0.encoder.pos_estimate
        self.odrv2.axis1.controller.input_pos = self.odrv1.axis1.encoder.pos_estimate

        self.odrv1.axis0.controller.config.control_mode = 3         #pos_mode
        self.odrv1.axis1.controller.config.control_mode = 3         #pos_mode
        self.odrv2.axis0.controller.config.control_mode = 3         #pos_mode
        self.odrv2.axis1.controller.config.control_mode = 3         #pos_mode

        self.odrv1.axis0.controller.config.input_mode = 5         #TRAP_TRAJ
        self.odrv1.axis1.controller.config.input_mode = 5         #TRAP_TRAJ
        self.odrv2.axis0.controller.config.input_mode = 5         #TRAP_TRAJ
        self.odrv2.axis1.controller.config.input_mode = 5         #TRAP_TRAJ
    ...
    def set_vel_control(self):
        ...
        self.odrv1.axis0.controller.config.vel_ramp_rate = 20
        self.odrv1.axis1.controller.config.vel_ramp_rate = 20

        self.odrv2.axis0.controller.config.control_mode = 2         #VEL_mode
        self.odrv2.axis1.controller.config.control_mode = 2         #VEL_mode
        self.odrv2.axis0.controller.config.input_mode = 2         #VEL_RAMP
        self.odrv2.axis1.controller.config.input_mode = 2         #VEL_RAMP
        self.odrv2.axis0.controller.config.vel_ramp_rate = 20
        self.odrv2.axis1.controller.config.vel_ramp_rate = 20

    def set_pos(self, pos):
        self.odrv1.axis0.controller.input_pos = pos[0]
        self.odrv1.axis1.controller.input_pos = pos[1]
        self.odrv2.axis0.controller.input_pos = pos[2]
        self.odrv2.axis1.controller.input_pos = pos[3]
    def set_vel(self, vel):
        self.odrv1.axis0.controller.input_vel = vel[0]
        self.odrv1.axis1.controller.input_vel = vel[1]
        self.odrv2.axis0.controller.input_vel = vel[2]
        self.odrv2.axis1.controller.input_vel = vel[3]
    def read_posvel(self):
        try:
            axis0_pos = self.odrv1.axis0.encoder.pos_estimate
            axis1_pos = self.odrv1.axis1.encoder.pos_estimate
            axis2_pos = self.odrv2.axis0.encoder.pos_estimate
            axis3_pos = self.odrv2.axis1.encoder.pos_estimate
            axis0_vel = self.odrv1.axis0.encoder.vel_estimate
            axis1_vel = self.odrv1.axis1.encoder.vel_estimate
            axis2_vel = self.odrv2.axis0.encoder.vel_estimate
            axis3_vel = self.odrv2.axis1.encoder.vel_estimate
            return [[axis0_pos, axis1_pos, axis2_pos, axis3_pos], [axis0_vel, axis1_vel, axis2_vel, axis3_vel]]
    ...
    def read_error(self):
        ...
        axis_error2 = self.odrv2.axis0.error
        axis_error3 = self.odrv2.axis1.error
        motor_error2 = self.odrv2.axis0.motor.error
        motor_error3 = self.odrv2.axis1.motor.error
        controller_error2 = self.odrv2.axis0.controller.error
        controller_error3 = self.odrv2.axis1.controller.error
        encoder_error2 = self.odrv2.axis0.encoder.error
        encoder_error3 = self.odrv2.axis1.encoder.error

        Errors = {'axis_error0' : axis_error0,
                  'axis_error1' : axis_error1,
                  'axis_error2' : axis_error2,
                  'axis_error3' : axis_error3,
                  'motor_error0' : motor_error0,
                  'motor_error1' : motor_error1,
                  'motor_error2' : motor_error2,
                  'motor_error3' : motor_error3,
                  'controller_error0' : controller_error0,
                  'controller_error1' : controller_error1,
                  'controller_error2' : controller_error2,
                  'controller_error3' : controller_error3,
                  'encoder_error0' : encoder_error0,
                  'encoder_error1' : encoder_error1,
                  'encoder_error2' : encoder_error2,
                  'encoder_error3' : encoder_error3}
